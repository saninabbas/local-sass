  ...
  return (
    <DashboardLayout>
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 mb-6">
        ...
        <div className="bg-[#efe9de] p-4 rounded-2xl border border-[#e6dfd8] shadow-xs">
          <span className="text-xs font-semibold text-[#6c6a64] font-sans">Grid Dimension & Radius</span>
          <div className="mt-2 text-2xl font-serif font-medium text-[#141413]">
            {geoData?.gridSize ? `${geoData.gridSize}x${geoData.gridSize}` : `${gridSize}x${gridSize}`} <span className="text-xs font-normal text-[#6c6a64] font-sans">({geoData?.radiusMiles || radiusMiles} mi)</span>
          </div>
        </div>
      </div>

      {/* Scan Parameter Form */}
      <div className="bg-[#efe9de] p-5 rounded-2xl border border-[#e6dfd8] shadow-xs mb-8">
        <form onSubmit={handleRunScan} className="grid grid-cols-1 sm:grid-cols-12 gap-3.5 items-end">
          <div className="sm:col-span-4">
            <label className="block text-xs font-bold text-[#6c6a64] font-mono uppercase tracking-wider mb-1">
              Target Search Query *
            </label>
            <input
              type="text"
              ...
              className="w-full px-3.5 py-2 text-xs rounded-xl border border-[#e6dfd8] bg-[#faf9f5] focus:bg-white text-[#141413] focus:outline-none focus:border-[#cc785c]"
            />
          </div>
