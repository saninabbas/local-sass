        ...
        <div className="mx-auto max-w-3xl px-6 lg:px-8 font-sans">
          ...
          <div className="space-y-6 text-sm text-[#3d3d3a] leading-relaxed">
            ...
            <div>
              ...
              <p>
                Permission is granted to temporarily access the materials (information or software) on Scorankio's website for personal, non-commercial transitory viewing only.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                The materials on Scorankio's website are provided "as is". Scorankio makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties, including without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
              </p>
            </div>
            ...
            <div>
              ...
              <p>
                In no event shall Scorankio or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on Scorankio's website.
              </p>
            </div>
          </div>
        </div>
