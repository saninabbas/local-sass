...
// .wrangler/tmp/bundle-HR9Arl/checked-fetch.js
...
// .wrangler/tmp/pages-H5ro83/functionsWorker-0.38723416288909107.mjs
...
var init_checked_fetch = __esm({
  "../.wrangler/tmp/bundle-1eeQHz/checked-fetch.js"() {
...
var init_email = __esm({
  "../src/lib/email.ts"() {
    init_functionsRoutes_0_7393054155785858();
    init_checked_fetch();
...
var init_totp = __esm({
  "../src/lib/totp.ts"() {
    init_functionsRoutes_0_7393054155785858();
    init_checked_fetch();
    __name2(base32ToBuf, "base32ToBuf");
...
__export(auditEngine_exports, {
  Extractor: /* @__PURE__ */ __name(() => Extractor, "Extractor"),
  askNVIDIA: /* @__PURE__ */ __name(() => askNVIDIA, "askNVIDIA"),
  compareWithNVIDIA: /* @__PURE__ */ __name(() => compareWithNVIDIA, "compareWithNVIDIA"),
  computeScores: /* @__PURE__ */ __name(() => computeScores, "computeScores"),
  fetchWithTimeout: /* @__PURE__ */ __name(() => fetchWithTimeout, "fetchWithTimeout"),
  generateBlogWithNVIDIA: /* @__PURE__ */ __name(() => generateBlogWithNVIDIA, "generateBlogWithNVIDIA"),
  getFallbackRecommendations: /* @__PURE__ */ __name(() => getFallbackRecommendations, "getFallbackRecommendations")
});
  ...
  "api/auditEngine.ts"() {
    ...
    Extractor = class {
      ...
      get handlers() {
        return {
          title: {
            text: /* @__PURE__ */ __name2((t) => {
              this.title += t.text;
            }, "text")
          },
          meta: {
            element: /* @__PURE__ */ __name2((e) => {
    ...
    __name2(computeScores, "computeScores");
    __name2(askNVIDIA, "askNVIDIA");
    __name2(compareWithNVIDIA, "compareWithNVIDIA");
    __name2(generateBlogWithNVIDIA, "generateBlogWithNVIDIA");
    __name2(getFallbackRecommendations, "getFallbackRecommendations");
  }
});
...
var init_route = __esm({
  "api/[[route]].ts"() {
    ...
    init_email();
    init_totp();
    buf2hex = /* @__PURE__ */ __name2((buffer) => [...new Uint8Array(buffer)].map((x) => x.toString(16).padStart(2, "0")).join(""), "buf2hex");
    hex2buf = /* @__PURE__ */ __name2((hex) => new Uint8Array((hex.match(/[\da-f]{2}/gi) || []).map((h) => parseInt(h, 16))).buffer, "hex2buf");
    __name2(hashPassword, "hashPassword");
    __name2(verifyPassword, "verifyPassword");
    generateId = /* @__PURE__ */ __name2((prefix) => `${prefix}_${crypto.randomUUID().replace(/-/g, "")}`, "generateId");
    __name2(parseCookies, "parseCookies");
    onRequest = /* @__PURE__ */ __name2(async (context) => {
      const { request, env } = context;
      const url = new URL(request.url);
      const jsonResponse = /* @__PURE__ */ __name2((data, status = 200, headers = {}) => new Response(JSON.stringify(data), {
        status,
        headers: { "Content-Type": "application/json", ...headers }
      }), "jsonResponse");
      const errorResponse = /* @__PURE__ */ __name2((error, status = 500) => jsonResponse({ success: false, error }, status), "errorResponse");
      const authenticate = /* @__PURE__ */ __name2(async () => {
      ...
      const executeAudit = /* @__PURE__ */ __name2(async (business) => {
      ...
      try {
        ...
        if (url.pathname === "/api/authority/backlinks" && request.method === "POST") {
          const user = await authenticate();
          if (!user) return errorResponse("Unauthorized", 401);
          const { source_url, target_url, anchor_text, status, notes } = await request.json();
          const id = crypto.randomUUID();
          await env.DB.prepare(
...
var routes;
var init_functionsRoutes_0_7393054155785858 = __esm({
  "../.wrangler/tmp/pages-H5ro83/functionsRoutes-0.7393054155785858.mjs"() {
    init_route();
    routes = [
      {
        routePath: "/api/:route*",
...
// .wrangler/tmp/bundle-HR9Arl/middleware-insertion-facade.js
...
// .wrangler/tmp/bundle-HR9Arl/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.38723416288909107.js.map
